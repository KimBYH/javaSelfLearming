...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        Comment a, b, c;
        a = new Comment(1L, article, "Park", "굿 윌 헌팅\"");
        b = new Comment(2L, article,"Kim", "아이 엠 샘");
        c = new Comment(3L, article,"Choi", "쇼생크 탈출");

        List<Comment> expected = Arrays.asList(a,b,c);

        assertEquals(expected.toString(), comments.toString(), "4번 글의 모든 댓글을 출력");
    */
        // Case 2 1L article Id를 가지고 테스트하기
        //입력 데이터
        Long articleId = 1L;
